...
//
// -----------------------------------------------------------------------------
// Removed automatic init() to avoid side effects and make initialization explicit
// Call Init() explicitly in main() or setup code

// NamespaceKey returns a single representative key for metric labeling.
